...
cant peroform bcs start at 0 and freetime is 4
...
if there is no zero in aray then you will always reach the end

seeing max where we can reach by each
...
can reach 8 so ans bcs we can defently reach 7
...
checking for each if intersecting

4 cases of intersection
![alt text](image-19.png)

![alt text](image-20.png)

optimizing
seeing from outside of station
as clock passes by
